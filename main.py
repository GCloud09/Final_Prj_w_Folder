...
def registration():
    ...
    if form.is_submitted():
        result = request.form
        query1 = """SELECT  max(ID)+1 as ID FROM `vn-project1.Credit.LoanData` LIMIT 1"""
        #dfread=pd.read_gbq(query1, project_id="vn-project1")
        newid=5 #dfread["ID"]
        print(newid)
        data = {
            'ID': [int(newid)],
        ...
        print(bool(form.houseownership.data))
        df = pd.DataFrame(data)
        print(df)
        # print('Profession ',  form.profession.data)
        # print('Experience ', form.experience.data)
        # print('Married_Single ', form.marriedyn.data)
        # print('House_Ownership ', form.houseownership.data)
        # print('CITY ', form.city.data)
        # print('STATE ', form.state.data)
        # print('Car_Ownership ', form.carownership.data)
        # print('CURRENT_JOB_YRS ', form.currentjobyrs.data)
        # print('CURRENT_HOUSE_YRS ', form.currenthouseyrs.data)
        print('start')
        print(df.dtypes)
...
@app.route('/registration_good', methods=['GET','POST'])  #to get formdata methods
def registration_good():
    form = RegistrationFormClass()
    if form.is_submitted():
        result = request.form
        successmsg="Your credit is approved"
